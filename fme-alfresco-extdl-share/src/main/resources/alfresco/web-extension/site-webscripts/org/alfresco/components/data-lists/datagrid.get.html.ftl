<@markup id="css" >
   ...
   <@link href="${url.context}/res/components/data-lists/extended-datagrid.css" group="datalists" />
</@>
...
<@markup id="js">
   ...
   <@script src="${url.context}/res/components/data-lists/extended-datagrid.js" group="datalists" />
</@>
...
<@markup id="html">
   <@uniqueIdDiv>
      ...
      <div id="${id}-body" class="datagrid">
         ...
         <div id="${id}-filter" style="visibility: hidden;padding-top:1em">
